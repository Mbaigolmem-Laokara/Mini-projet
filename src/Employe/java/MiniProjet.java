...
class Salaires {
    public static void main(String[] args) {
        ...
        p.ajouterEmploye(new Representant("01A023","PAUL", "Issa", 28, "2001", 20000));
        p.ajouterEmploye(new Technicien("98A032","DR", "Junior", 28, "1998", 1000));
        p.ajouterEmploye(new Manutentionnaire("98A033","ADAM", "Tato", 33, "1998", 45));
        p.ajouterEmploye(new TechnARisque("10A025","Nassour", "YAYA", 48, "2010", 1000));
        p.ajouterEmploye(new ManutARisque("01A024","MAHAMADOU", "Denis", 31, "2001", 45));
